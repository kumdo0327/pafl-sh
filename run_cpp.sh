...
if [ $# -eq 1 ];
then
    ~/PAFL/PAFL/main -p cpp_peglib -l cpp -m $1 -v 8,9,7,6,5,4,2,3,1,10 -d ~/bugscpp/cpp_peglib -t ~/bugscpp/test_cpp_peglib -i ~/PAFL/oracle
    ~/PAFL/PAFL/main -p exiv2 -l cpp -m $1 -v 10,15,14,4,13,6,8,9,11,12,7,5,16,17,3,2,1,18-20 -d ~/bugscpp/exiv2 -t ~/bugscpp/test_exiv2 -i ~/PAFL/oracle
...
then
    ~/PAFL/PAFL/main -p cpp_peglib -l cpp -m $1 -v 8,9,7,6,5,4,2,3,1,10 -d ~/bugscpp/cpp_peglib -t ~/bugscpp/test_cpp_peglib -i ~/PAFL/oracle $2
    ~/PAFL/PAFL/main -p exiv2 -l cpp -m $1 -v 10,15,14,4,13,6,8,9,11,12,7,5,16,17,3,2,1,18-20 -d ~/bugscpp/exiv2 -t ~/bugscpp/test_exiv2 -i ~/PAFL/oracle $2
...
then
    ~/PAFL/PAFL/main -p cpp_peglib -l cpp -m $1 -v 8,9,7,6,5,4,2,3,1,10 -d ~/bugscpp/cpp_peglib -t ~/bugscpp/test_cpp_peglib -i ~/PAFL/oracle $2 $3
    ~/PAFL/PAFL/main -p exiv2 -l cpp -m $1 -v 10,15,14,4,13,6,8,9,11,12,7,5,16,17,3,2,1,18-20 -d ~/bugscpp/exiv2 -t ~/bugscpp/test_exiv2 -i ~/PAFL/oracle $2 $3
