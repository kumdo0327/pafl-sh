...
then
    ...
    ~/PAFL/PAFL/main -p yaml_cpp -l cpp -m $1 -v 10,1-9 -d /4tb/donguk/bugscpp/yaml_cpp -t /4tb/donguk/bugscpp/test_yaml_cpp -i ~/PAFL/oracle
...
then
    ...
    ~/PAFL/PAFL/main -p yaml_cpp -l cpp -m $1 -v 10,1-9 -d /4tb/donguk/bugscpp/yaml_cpp -t /4tb/donguk/bugscpp/test_yaml_cpp -i ~/PAFL/oracle $2
...
then
    ...
    ~/PAFL/PAFL/main -p yaml_cpp -l cpp -m $1 -v 10,1-9 -d /4tb/donguk/bugscpp/yaml_cpp -t /4tb/donguk/bugscpp/test_yaml_cpp -i ~/PAFL/oracle $2 $3
