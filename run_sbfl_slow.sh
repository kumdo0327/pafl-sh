...
then
    ...
    ~/PAFL/PAFL/main -p youtube-dl -l python -m $1 -v 35-31,10-8,30,7,29,28,6,27,26,5,25,24,23-18,3,16,2,15,1,13,12,11 -d /4tb/donguk/BugsInPy/youtube-dl -t /4tb/donguk/BugsInPy/youtube-dl -i ~/PAFL/oracle $2
elif [ $# -eq 3 ];
then
    ...
    ~/PAFL/PAFL/main -p youtube-dl -l python -m $1 -v 35-31,10-8,30,7,29,28,6,27,26,5,25,24,23-18,3,16,2,15,1,13,12,11 -d /4tb/donguk/BugsInPy/youtube-dl -t /4tb/donguk/BugsInPy/youtube-dl -i ~/PAFL/oracle $2 $3
else
    exit 1
fi
