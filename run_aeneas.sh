...
then
    ...
    ~/PAFL/PAFL/main -p exiv2 -l cpp -m aeneas-ochiai,aeneas-dstar,aeneas-barinel -v 10,15,14,4,13,6,8,9,11,12,7,5,16,17,3,2,1,18-20 -d /4tb/donguk/bugscpp/exiv2 -t /4tb/donguk/bugscpp/test_exiv2 -i ~/PAFL/oracle $1
...
then
    ...
    ~/PAFL/PAFL/main -p exiv2 -l cpp -m aeneas-ochiai,aeneas-dstar,aeneas-barinel -v 10,15,14,4,13,6,8,9,11,12,7,5,16,17,3,2,1,18-20 -d /4tb/donguk/bugscpp/exiv2 -t /4tb/donguk/bugscpp/test_exiv2 -i ~/PAFL/oracle $1 $2
